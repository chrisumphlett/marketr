...
#'
#' Transposes survey data from wide to long to prepare for tidy calculation of
#' CXi.
#'
#' This function is called by other functions in the package that do the final
#' CXi calculations.
#'
...
#' @param ... optional colunns by which to group the CXi calculation. There
#' is no limit to the number of grouping variables chosen. Too many will likely
...
#'
#' @return Data frame with one row per survey response for each of the three
#' CXi questions.
#'
#' @import dplyr
#' @importFrom magrittr "%>%"
